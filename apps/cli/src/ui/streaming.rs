    ...
    while processed < max_per_frame {
        ...
        match chunk {
            ...
            StreamChunk::Status { content } => {
                ...
                app.history.push(Message::system(format!("[QIR] {}", content)));
            }
            StreamChunk::SessionStats { total_tokens, total_cost, qir_attempts } => {
            ...
            StreamChunk::Error { content } => {
                ...
                app.history.push(Message::system(format!("Error: {}", display)));
                app.is_generating = false;
                app.active_tool = None;
                app.qir_retry_status = None;
            }
