...
class FileEditInput(BaseModel):
    ...
    allow_multiple: bool = Field(
        False,
        description="If True, replace all occurrences of old_string. If False, only succeed if exactly one occurrence is found.",
    )
...
class FileEditTool(BaseTool):
    ...
    def prompt(self) -> str:
        return (
            "- file_edit: Make surgical string replacements in files. "
        ...
        **kwargs,
        ...
        try:
            ...
            if count == 0:
                return {
                    "success": False,
                    "error": "The 'old_string' was not found in the file. Ensure it matches exactly.",
                }

            if not allow_multiple and count > 1:
                return {
                    "success": False,
                    "error": f"The 'old_string' was found {count} times. Please provide more context to make it unique, or set allow_multiple=True.",
                }
