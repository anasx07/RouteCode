...
BASE_THEME = {
    ...
    "border": "bright_black",
    "title": "bold white",
    "toolbar": "white on grey15",
    "user": "bold white",
    "ai": "bold white",
    "thought": "italic bright_black",
    "tool_bash": "bold cyan",
    "tool_read": "bold blue",
    "tool_edit": "bold yellow",
    "tool_write": "bold magenta",
    "tool_glob": "bold green",
    "tool_grep": "bold green",
    "tool_task": "bold white",
    "tool_skill": "bold white",
    "tool_webfetch": "bold cyan",
    "stats_label": "bright_black",
    "stats_value": "white",
}
...
THEMES = {
    name: {
        **BASE_THEME,
        ...
        # Per-theme overrides
        **(
            {"command": "bold cyan", "toolbar": "bright_black on grey3"}
            if name == "midnight"
            else {}
        ),
    }
...
def apply_theme(name: str = "lava"):
    ...
    routecode_theme = Theme(theme_dict)
    ...
    actual_console = Console(
        theme=routecode_theme,
        force_terminal=True,
        color_system="truecolor",
        style=f"on {bg}",
    )
    actual_mirror = Console(
        theme=routecode_theme,
        file=_mirror_output,
        force_terminal=True,
        color_system="truecolor",
