---
name: help
description: Explains how to use and create skills in RouteCodeCLI
context: inline
---

# RouteCodeCLI Skills Guide

Skills are Markdown files with frontmatter that define reusable prompts or autonomous sub-agent tasks.

## How to Create a Skill
Create a `.md` file in `~/.routecodecli/skills/` with the following format:
